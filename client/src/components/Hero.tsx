...
function Hero({ onViewCatalog, onViewHistory, config }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.03] dark:opacity-[0.02] hidden sm:block" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            ...
            <motion.div
              ...
              transition={{ type: isMobile || reducedMotion ? 'tween' : 'spring', duration: isMobile ? 0.5 : undefined, stiffness: isMobile ? undefined : 80, damping: isMobile ? undefined : 16 }}
